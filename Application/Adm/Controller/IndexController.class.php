...
class IndexController extends BackendController {
    ...
    public function _initialize() {
      ...
      //  $group_mod = D("group");
      //  $site_mod = D("Site");
      //  $site_menu = $site_mod->site_init();
      //  $group_menu = $group_mod->group_init();
       // $this->assign('site_select', $site_menu);
      //  $this->assign('group_select', $group_menu);
    }
    ...
    public function panel() {
        ...
        $system_info = array(
            'ZhiPHP_version' => ZHI_VERSION . ' RELEASE '. ZHI_RELEASE .' [<a href="" class="blue" target="_blank">查看最新版本</a>]',
    ...
    public function login() {
        if (IS_POST) {
            ...
            $this->success(L('login_success'), U(GROUP_NAME.'/Index/index'));
        } else {
            $this->display();
        }
    }
    ...
    public function logout() {
        session('admin', null);
        $this->success(L('logout_success'), U(GROUP_NAME.'/Index/login'));
        exit;
    }

    public function verify_code() {
        import("Extend.ORG.Image",LIB_PATH);
