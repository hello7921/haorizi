...
<head>
	...
	var SELF = '/haorizi/amd.php?s=/Article/edit/id/3194.html';
			...
			<div class="content_list pad_10">
				<table width="100%" cellspacing="0" class="table_form">
		            ...
		            <tr>
						...
						<td>
                        <?php if(!empty($info['img'])): ?><span class="attachment_icon J_attachment_icon" file-type="image" file-rel="<?php echo ($info["_img"]); ?>"></span><br /><?php endif; ?>
		            ...
		            <tr>
		                <th>详细内容 :</th>
						<td><textarea name="content" id="content" style="width:80%;height:400px;visibility:hidden;resize:none;"><?php echo ($info["content"]); ?></textarea></td>
					</tr>
				</table>
			</div>
