...
<div class="dialog_content">
	...
	<table width="100%" class="table_form">
		<tr>
      		...
      		<td><input type="text" name="username" id="J_username" class="input-text" value="<?php echo ($_info["username"]); ?>"></td>
    	</tr>
    	<tr> 
      ...
      <tr>
        ...
        <td><input type="text" name="email" class="input-text" value="<?php echo ($_info["email"]); ?>" size="30"></td>
      </tr>
    	<tr>
      		<th><?php echo L('admininrole');?> :</th>
      		<td>
      			<select name="role_id">
        			<?php if(is_array($role_list)): $i = 0; $__LIST__ = $role_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><option value="<?php echo ($val["id"]); ?>" <?php if($val['id'] == $_info['role_id']): ?>selected="selected"<?php endif; ?>><?php echo ($val["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
        		</select>
      		</td>
    	</tr>
	</table>
...
<script>
var check_name_url = "<?php echo U('admin/ajax_check_name', array('id'=>$_info['id']));?>";
$(function(){
