...
<head>
	...
	<script>
	var URL = '/haorizi/amd.php?s=/Admin';
	var SELF = '/haorizi/amd.php?s=/admin/index/menuid/61.html';
    ...
    <div class="J_tablelist table_list" data-acturi="<?php echo U('admin/ajax_edit');?>">
        <table width="100%" cellspacing="0">
            ...
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td align="center">
                    <img data-tdtype="toggle" data-field="status" data-id="<?php echo ($val["id"]); ?>" data-value="<?php echo ($val["status"]); ?>" src="/haorizi/Public/public/css/admin/bgimg/toggle_<?php if($val["status"] == 0): ?>disabled<?php else: ?>enabled<?php endif; ?>.gif" />
                </td>
                <td align="center">
